...
class Learner(BaseLearner):
    def __init__(self, args):
        ...
        self.teach_args["backbone_type"] = "resnet18"
    ...
    def incremental_train(self, data_manager):
        ...
        self.train_loader_t=self.train_loader #t
    ...
    def _train(self, train_loader, test_loader):
        ...
        self._init_train(train_loader, test_loader, optimizer, scheduler, teach_optimizer, teach_scheduler)
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler, teach_optimizer, teach_scheduler):
        #t
        if self._cur_task == 0:
            t_epochs = init_epoch
        else:
        ...
        for epoch in range(t_epochs):
            ...
            if epoch % 5 == 4:
                test_acc = self._compute_accuracy_t(self._teach_network, test_loader)
    ...
    #t
    def _compute_accuracy_t(self, model, loader):
        model.eval()
        correct, total = 0, 0
        for i, (_, inputs, targets) in enumerate(loader):
            inputs = inputs.to(self._device)
