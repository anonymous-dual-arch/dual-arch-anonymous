...
def get_backbone(args, pretrained=False):
    ...
    if name == "pretrained_vit_b16_224" or name == "vit_base_patch16_224":
        ...
        pretrained_cfg['file'] = 'path/to/models--timm--vit_base_patch16_224.augreg2_in21k_ft_in1k/pytorch_model.bin'

        model = timm.create_model("vit_base_patch16_224",pretrained=True, num_classes=0, pretrained_cfg=pretrained_cfg)
        model.out_dim = 768
        return model.eval()
    ...
    # L2P
        ...
        if args["model_name"] == "l2p" or args["model_name"] == "l2p_t":
    ...
    # dualprompt
        ...
        if args["model_name"] == "dualprompt" or args["model_name"] == "dualprompt_t":
