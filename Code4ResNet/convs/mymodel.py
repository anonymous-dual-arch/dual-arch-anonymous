...
class ResNetBasicblock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        if inplanes != planes * self.expansion or stride !=1:
            downsample = DownsampleB(inplanes, planes * self.expansion, stride)
...
class Net(nn.Module):
    def __init__(self, depth, width, pool, double, args=None):
        ...
        for i in range(depth):
            ...
            self.layers.append(ResNetBasicblock(last_width, width, 1))
            
        self.global_pooling = nn.AdaptiveAvgPool2d(2)
...
def mm(pretrained=False, progress=True, args=None, **kwargs):
