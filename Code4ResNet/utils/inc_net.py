...
from convs.resnet import resnet10, resnet18, resnet34, resnet50, resnet101, resnet152
...
def get_convnet(args, pretrained=False):
    ...
    #my
        ...
        return mm(pretrained=False,args=args)
    #Arch_Craft
...
class BEEFISONet(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.old_fc is None:
            ...
            fc_bias = torch.cat([self.old_fc.bias,torch.zeros(new_task_size).to(self._device)])
            fc_bias=+new_fc_bias
